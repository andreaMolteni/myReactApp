...
export default function Todo ({todoItem, onRemoveTodo, toggleTodo}){
    ...
    return  <li className="list-group-item">
                ...
                {todoItem.name}
                <button type="button" onClick={() => onRemoveTodo(todoItem.id)} className="btn btn-outline-danger float-end px-2 py-1">Delete</button>
            </li>
}